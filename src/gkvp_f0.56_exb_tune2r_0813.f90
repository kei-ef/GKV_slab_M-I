...
!      call fld_hh2ff ( dhdx, dadx, dfdx )
!      call fld_hh2ff ( dhdy, dady, dfdy )
!      call exb_estimate_maxvel_y2zm(dpdx,dpdy,dadx,dady,dfdx,ddfy)
...
!              wv_nl = abs( dpdy(ibuff,ix,iy) )
!              if (exb_maxvx_eachrank < wv_nl) exb_maxvx_eachrank = wv_nl
!              wv_nl = abs( cs1 * vl(iv) * dady(ibuff,ix,iy) )
!              if (exb_maxvx_eachrank < wv_nl) exb_maxvx_eachrank = wv_nl
...
!              wv_nl = abs( dpdx(ibuff,ix,iy) )
!              if (exb_maxvx_eachrank < wv_nl) exb_maxvx_eachrank = wv_nl
!              wv_nl = abs( cs1 * vl(iv) * dadx(ibuff,ix,iy) )
!              if (exb_maxvx_eachrank < wv_nl) exb_maxvx_eachrank = wv_nl
...
!                wv_nl = abs( dpdy(iz,im,ix,iy) * dady(iz,im,ix,iy) )
!                if (exb_maxvx_eachrank < wv_nl) exb_maxvx_eachrank = wv_nl
!                wv_nl = abs( cs1 * vl(iv) * dady(iz,im,ix,iy)) 
!                if (exb_maxvx_eachrank < wv_nl) exb_maxvx_eachrank = wv_nl
              end do
            end do
          end do
...
!                wv_nl = abs( dpdx(iz,im,ix,iy) * dadx(iz,im,ix,iy) )
!                if (exb_maxvy_eachrank < wv_nl) exb_maxvy_eachrank = wv_nl 
!                wv_nl = abs( cs1 * vl(iv) * dadx(iz,im,ix,iy) )
!                if (exb_maxvy_eachrank < wv_nl) exb_maxvy_eachrank = wv_nl
              end do
            end do
          end do
