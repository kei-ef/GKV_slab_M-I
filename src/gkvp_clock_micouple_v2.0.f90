    ...
    real(kind=DP)        :: ttotl
      ...
      if( isw == 0 ) then
       ...
       !elt(1440) = elt(1441) + elt(1442) + elt(1443); ccount(1440) = ccount(1441)
        ...
        write( olog, '(a22,f15.5,i15)' ) "   dtccontrl        = ", elt(18), ccount(18)
        write( olog, '(a22,f15.5,i15)' ) "   other            = ", elt(2)-elt(10)-elt(11) &
                                         -elt(12)-elt(13)-elt(14)-elt(15)-elt(16)-elt(17)-elt(18), &
                                          ccount(2)
        write( olog, * ) " #####################################################"

! fujita added (M-I ver.2.0)
! M-I adv
        write( olog, * ) ""
        write( olog, * ) " ######### elapsed time (sec) and call count (iono) #########"
        write( olog, '(a22,f15.5,i15)' ) "   ionosphere total    = ", elt(1630), ccount(1630)
        write( olog, '(a22,f15.5,i15)' ) "   ionosphere pssn     = ", elt(1610), ccount(1610)
        write( olog, '(a22,f15.5,i15)' ) "   ionosphere div-grad = ", elt(1620), ccount(1620)
! distribution function in real space
        write( olog, * ) ""
        write( olog, * ) " ######### elapsed time (sec) and call count (fout) #########"
        write( olog, '(a22,f15.5,i15)' ) "   fout total      = ", elt(1800), ccount(1800)
        write( olog, '(a22,f15.5,i15)' ) "   fout fft x      = ", elt(1810), ccount(1810)
        write( olog, '(a22,f15.5,i15)' ) "   fout fft y      = ", elt(1811), ccount(1811)
        write( olog, '(a22,f15.5,i15)' ) "   fout gather     = ", elt(1820), ccount(1820)
        write( olog, '(a22,f15.5,i15)' ) "   fout out        = ", elt(1830), ccount(1830)
