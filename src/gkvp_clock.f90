    ...
    real(kind=DP)        :: ttotl
      ...
      if( isw == 0 ) then
       ...
       !elt(1440) = elt(1441) + elt(1442) + elt(1443); ccount(1440) = ccount(1441)
        ...
        write( olog, * ) ""
        write( olog, * ) " ######### elapsed time (sec) and call count (debug) #########"
        write( olog, '(a22,f15.5,i15)' ) "   fout total      = ", elt(1740), ccount(1740)
        write( olog, '(a22,f15.5,i15)' ) "   fout fft x      = ", elt(1710), ccount(1710)
        write( olog, '(a22,f15.5,i15)' ) "   fout fft y      = ", elt(1711), ccount(1711)
        write( olog, '(a22,f15.5,i15)' ) "   fout gather     = ", elt(1720), ccount(1720)
        write( olog, '(a22,f15.5,i15)' ) "   fout out        = ", elt(1730), ccount(1730)
