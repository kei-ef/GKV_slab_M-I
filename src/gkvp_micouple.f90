...
!
    ...
    integer :: i
      ...
      fctze = 1.0d0 + zetae * fncze

      call calc_disp_func( zetai, fnczi )
      fctzi = 1.0d0 + zetai * fnczi
    ...
    integer :: i, sgm
      ...
      if ( abs(zeta) < 1.0d-2 ) then
        ...
        zout = ui * pi**0.5_DP * dble(sgm) * exp( -zeta**2 ) &
               - 1.0_DP / zeta * ( 1.0d0 + 0.5d0/zeta**2 + 3.0d0/4.0d0/zeta**4 )
