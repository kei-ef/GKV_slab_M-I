...
#---PBS -q medium
#PBS -q large
#PBS --group=24269                # resource group
#PBS -T necmpi                    # necessary for MPI job
#PBS -l elapstim_req=03:00:00     # elapsed time limit
...
### For NetCDF
#module load netcdf-parallelIO-fortran-sx/4.5.2


### Working directory 
DIR=%%DIR%%
LDM=gkvp.exe
NL=gkvp_micouple_namelist.%%%
#NL=gkvp_namelist.%%%
...
mpirun -n ${MPI_procs} ./mpisep.sh ${DIR}/${LDM}
